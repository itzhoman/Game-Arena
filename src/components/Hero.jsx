...
const Hero = () => {
    ...
    useEffect(() => {
        ...
        // Animate gradient for "Immersive Gaming" text
    ...
    return (
        <div className='flex justify-between items-center w-full min-h-[700px] bg-gradient-background text-[var(--color-text-primary)] relative overflow-hidden'>
            ...
            <div className='absolute top-0 left-0 w-full h-full'>
                <div className='absolute top-20 left-20 w-72 h-72 bg-[var(--color-primary)] rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob'></div>
                <div className='absolute top-40 right-20 w-72 h-72 bg-[var(--color-primary)] rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000'></div>
                <div className='absolute bottom-20 left-40 w-72 h-72 bg-[var(--color-secondary)] rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000'></div>
            </div>
            ...
            >
                ...
                <div ref={buttonsRef} className='flex gap-4 mt-8'>
                    <motion.button 
                        ...
                        duration-500 w-[150px] p-3 tracking-widest rounded-full font-semibold shadow-lg hover:shadow-xl opacity-0'
                    >
                        Buy Now
                    </motion.button>
                    <motion.button 
                        ...
                        duration-500 w-[150px] p-3 tracking-widest rounded-full font-semibold opacity-0'
                    >
                        Learn More
                    </motion.button>
                </div>
            ...
            >
                <div className='relative'>
                    ...
                    <img 
                        ...
                        src={HeroImage} 
                        alt="Gaming Setup" 
                        className='relative w-[500px] h object-contain h-[450px]'
                    />
                </div>
            </motion.div>
        </div>
