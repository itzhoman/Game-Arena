...
const Footer = () => {
    ...
    return (
        <div
            ref={footerRef}
            className='bg-secondary text-black py-10 mt-20'
        >
                    ...
                    <ul>
                        {quickLinks.map((link) => (
                            <li key={link.key} className='mb-2'>
                                <a href={link.url} className='hover:text-white font-bold text-lg'> {link.label}</a>
                            </li>
                        ))}
                    </ul>
                </div>
                ...
                <div className='sm:col-span-1 text-center sm:text-left'>
                    ...
                    <ul className='flex flex-col items-center sm:items-start gap-3'>
                        {socialLinks.map((link) => (
                            <li key={link.key}>
                                <a href={link.url} className='flex items-center gap-3 hover:text-white font-bold
                                    text-lg'>
